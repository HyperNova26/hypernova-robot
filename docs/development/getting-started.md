...
공통 개발 환경은 아직 정하지 않았습니다. 지금 필요한 건 Git, Markdown 편집기, 저장소·PR 작업에 쓸 GitHub CLI(`gh`) 정도입니다.

ROS 2 배포판과 운영체제, 컴파일러, 컨테이너, 시뮬레이터 버전은 첫 소프트웨어 ADR에서 정합니다. 그전까지는 각자 환경 설정을 프로젝트 표준인 것처럼 커밋하지 마세요.
